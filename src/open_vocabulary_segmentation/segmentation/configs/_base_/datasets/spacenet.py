...
class SpaceNetDataset(BaseSegDataset):
    """SpaceNet dataset for road extraction."""
    METAINFO = dict(
...
dataset_type = "SpaceNetDataset"
data_root = "/mnt/sdb/luoyichang/datasets/road_extraction/SpaceNet_test_567/cvt"
...
test_cfg = dict(mode="slide", stride=(224, 224), crop_size=(448, 448)) #默认
