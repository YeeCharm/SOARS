...
class InriaDataset(BaseSegDataset):
    """Inria dataset for building extraction."""
    METAINFO = dict(
...
data_root = "/mnt/sdb/luoyichang/datasets/building_extraction/Inria/processed"
...
data = dict(
    test=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(img_path='img_dir/split_test', seg_map_path='ann_dir/split_test'),
