...
class CHN6CUGDataset(BaseSegDataset):
    """CHN6-CUG dataset for road extraction."""
    METAINFO = dict(
...
dataset_type = "CHN6CUGDataset"
data_root = "/mnt/sdb/luoyichang/datasets/road_extraction/CHN6-CUG/val"
