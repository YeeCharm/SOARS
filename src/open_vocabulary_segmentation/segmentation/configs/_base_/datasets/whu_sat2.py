...
class WHUSatellite2Dataset(BaseSegDataset):
    """WHU Satellite-2 dataset for building extraction."""
    METAINFO = dict(
...
dataset_type = "WHUSatellite2Dataset"
data_root = "/mnt/sdb/luoyichang/datasets/building_extraction/WHU_Building_Dataset/Satellite_2/processed"
